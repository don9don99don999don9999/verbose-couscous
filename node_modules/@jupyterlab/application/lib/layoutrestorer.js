 ...
 */
var LayoutRestorer = /** @class */ (function () {
    /**
    ...
    function LayoutRestorer(options) {
        ...
        this._first
            .then(function () { _this._firstDone = true; })
            .then(function () { return Promise.all(_this._promises); })
            .then(function () {
            _this._promisesDone = true;
    ...
    LayoutRestorer.prototype.restore = function (tracker, options) {
        ...
        if (this._trackers.has(namespace)) {
            var warning_1 = "A tracker namespaced " + namespace + " was already restored.";
            console.warn(warning_1);
            return Promise.reject(warning_1);
        }
        ...
        tracker.widgetAdded.connect(function (sender, widget) {
            ...
            if (widgetName) {
                _this.add(widget, namespace + ":" + widgetName);
            }
        }, this);
        // Whenever a widget is updated, get its new name.
        tracker.widgetUpdated.connect(function (sender, widget) {
            var widgetName = name(widget);
            if (widgetName) {
                var name_1 = namespace + ":" + widgetName;
                Private.nameProperty.set(widget, name_1);
                _this._widgets.set(name_1, widget);
            }
        });
