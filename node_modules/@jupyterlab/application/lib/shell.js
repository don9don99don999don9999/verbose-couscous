...
var ApplicationShell = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ApplicationShell.prototype, "leftCollapsed", {
        /**
    ...
    Object.defineProperty(ApplicationShell.prototype, "rightCollapsed", {
        /**
         * Whether the left area is collapsed.
         */
        get: function () {
    ...
    Object.defineProperty(ApplicationShell.prototype, "presentationMode", {
        /**
    ...
    */
     ...
     */
    ApplicationShell.prototype.expandLeft = function () {
     ...
     * or the first tab if there is no most recently used.
     */
    ApplicationShell.prototype.expandRight = function () {
...
(function (Private) {
    ...
    var SideBarHandler = /** @class */ (function () {
         ...
         */
        SideBarHandler.prototype.expand = function () {
            var previous = this._lastCurrent || (this._items.length > 0 && this._items[0].widget);
            if (previous) {
