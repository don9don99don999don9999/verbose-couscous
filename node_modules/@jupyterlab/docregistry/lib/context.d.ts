...
export declare class Context<T extends DocumentRegistry.IModel> implements DocumentRegistry.IContext<T> {
     ...
     */
    private _onSessionChanged(sender, type);
    /**
     ...
     */
    private _maybeSave(options);
    /**
     * Handle a save/load error with a dialog.
     */
    private _handleError(err, title);
    /**
     * Add a checkpoint the file is writable.
     */
    private _maybeCheckpoint(force);
    /**
     * Handle a time conflict.
     */
    private _timeConflict(tClient, model, options);
    /**
     * Handle a time conflict.
     */
    private _maybeOverWrite(path);
    /**
     * Finish a saveAs operation given a new path.
     */
    private _finishSaveAs(newPath);
    private _manager;
    private _opener;
    private _model;
    private _modelDB;
