 ...
 */
var LauncherModel = /** @class */ (function (_super) {
...
var Launcher = /** @class */ (function (_super) {
    ...
    function Launcher(options) {
        ...
        _this._cwd = '';
        _this._cwd = options.cwd;
        _this._callback = options.callback;
        _this.addClass(LAUNCHER_CLASS);
        return _this;
    }
    Object.defineProperty(Launcher.prototype, "cwd", {
        /**
    ...
    Launcher.prototype.render = function () {
        ...
        algorithm_1.each(orderedCategories, function (cat) {
            ...
            if (cat in categories) {
                section = (React.createElement("div", { className: 'jp-Launcher-section', key: cat },
                    ...
                    React.createElement("div", { className: 'jp-Launcher-cardContainer' }, algorithm_1.toArray(algorithm_1.map(categories[cat], function (item) {
...
function Card(kernel, item, launcher, launcherCallback) {
    ...
    return (React.createElement("div", { className: 'jp-LauncherCard', title: item.displayName, onClick: onclick, "data-category": item.category || 'Other', key: Private.keyProperty.get(item) },
        React.createElement("div", { className: 'jp-LauncherCard-icon' },
            (item.kernelIconUrl && kernel) &&
                React.createElement("img", { src: item.kernelIconUrl, className: 'jp-Launcher-kernelIcon' }),
            (!item.kernelIconUrl && !kernel) &&
                React.createElement("div", { className: item.iconClass + " jp-Launcher-icon" }),
            (!item.kernelIconUrl && kernel) &&
                React.createElement("div", { className: 'jp-LauncherCard-noKernelIcon' }, item.displayName[0].toUpperCase())),
        React.createElement("div", { className: 'jp-LauncherCard-label', title: item.displayName }, item.displayName)));
}
/**
