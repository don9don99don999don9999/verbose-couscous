 ...
 */
var CommandLinker = /** @class */ (function () {
    /**
    ...
    CommandLinker.prototype.populateVNodeDataset = function (command, args) {
        var dataset;
        if (args !== void 0) {
            dataset = (_a = {}, _a[ARGS_ATTR] = JSON.stringify(args), _a[COMMAND_ATTR] = command, _a);
        }
        else {
            dataset = (_b = {}, _b[COMMAND_ATTR] = command, _b);
        }
        return dataset;
        var _a, _b;
    };
    ...
    CommandLinker.prototype._evtClick = function (event) {
        ...
        while (target && target.parentElement) {
            if (target.hasAttribute("data-" + COMMAND_ATTR)) {
                ...
                var args = coreutils_1.JSONExt.emptyObject;
                if (argsValue) {
