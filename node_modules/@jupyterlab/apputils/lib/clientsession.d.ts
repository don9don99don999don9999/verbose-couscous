...
export declare class ClientSession implements IClientSession {
     ...
     */
    private _startSession(model);
    /**
     * Handle a new session object.
     */
    private _handleNewSession(session);
    /**
     * Handle an error in session startup.
     */
    private _handleSessionError(err);
    /**
     ...
     */
    private _onPropertyChanged(sender, property);
    /**
     ...
     */
    private _onIopubMessage(sender, message);
    /**
     * Handle an unhandled message.
     */
    private _onUnhandledMessage(sender, message);
    private _path;
    private _name;
    private _type;
