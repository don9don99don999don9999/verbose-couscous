...
var ToolbarButton = /** @class */ (function (_super) {
    ...
    function ToolbarButton(options) {
        ...
        styling_1.Styling.styleNodeByTag(_this.node, 'button');
        ...
        if (classes) {
            classes.forEach(function (name) { _this.addClass(name); });
        }
...
(function (Private) {
     ...
     */
    var KernelName = /** @class */ (function (_super) {
     ...
     */
    var KernelStatus = /** @class */ (function (_super) {
