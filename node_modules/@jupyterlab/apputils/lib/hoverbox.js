...
(function (HoverBox) {
    ...
    function setGeometry(options) {
        var anchor = options.anchor, host = options.host, node = options.node, privilege = options.privilege;
        ...
        var style = options.style || window.getComputedStyle(node);
        ...
        var renderBelow = privilege === 'forceAbove' ? false
